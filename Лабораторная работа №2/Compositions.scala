...
//и еще выполняют с помощью цикла, который выполняется один раз и в нем последовательно выполняются функции, результат возвращается с помощью yield
package myLab3
...
object Compositions {
  ...
  def main(args: Array[String]): Unit = {
    println(testCompose(Func1)(Func2)(Func3)('n')) // ascii of [space] is 32
